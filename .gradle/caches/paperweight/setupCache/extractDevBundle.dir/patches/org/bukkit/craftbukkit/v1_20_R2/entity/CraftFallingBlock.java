...
public class CraftFallingBlock extends CraftEntity implements FallingBlock {
    ...
    public org.bukkit.block.BlockState getBlockState() {
        return org.bukkit.craftbukkit.v1_20_R2.block.CraftBlockStates.getBlockState(this.getHandle().blockState, this.getHandle().blockData);
    }
    ...
    public void setBlockState(final org.bukkit.block.BlockState blockState) {
        ...
        if (blockState instanceof final org.bukkit.craftbukkit.v1_20_R2.block.CraftBlockEntityState<?> tileEntity) this.getHandle().blockData = tileEntity.getSnapshotNBT();
    }
    // Paper end
